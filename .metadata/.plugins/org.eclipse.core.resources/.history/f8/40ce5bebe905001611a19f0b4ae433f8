...
public class Driver {
	...
	public static void main(String[] args) {
		...
		//System.out.println("id: " + utyp.getId() + " Name: " + utyp.getName());
		//utyp.setName("fan");
		//int return_val = uts.updateUserType(conn.getMyConn(), utyp);
		//System.out.println("Return Value " + return_val);
		//int return_val = uts.deleteUserTypes(conn.getMyConn(), utyp);
		//System.out.println("Return Value " + return_val);
		//List <UserType> userTypes = uts.getAllUserTypes(conn.getMyConn());
		
		//for (int i = 0; i < userTypes.size(); i++) {
		//	UserType ut =  userTypes.get(i);
		//	System.out.println("id: " + ut.getId() + " Name: " + ut.getName());
		//}
        ...
        //List <EventType> eventTypes = ets.getAllEventTypes(conn.getMyConn());
		...
		//int return_val = us.addUser(conn.getMyConn(), utyp.getName(),usr);
		//System.out.println("Return Value " + return_val);
